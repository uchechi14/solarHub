...
import chair from "../../public/images/solar-panels-meadow 2.svg";
      ...
      <div className="w-[90%]">
        ...
        <div className="grid md:grid-cols-3 grid-cols-1 gap-5 w-full">
          {ImageItem.map((items, index) => (
            <div key={index} className="flex flex-col gap-2.5 items-center">
              <div className="w-full">
                <Image src={items.image} alt="chair" className="w-full" />
              </div>
